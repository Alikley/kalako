    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-kalako-slate-600 leading-loose">
          ...
          <p>ما با پوشش بیش از <strong className="text-kalako-navy">۱۰ دسته‌بندی</strong> شامل {CATEGORIES.slice(0, 5).join("، ")} و ده‌ها برند معتبر مانند {BRANDS.slice(0, 5).join("، ")}، یکی از کامل‌ترین پایگاه‌های جستجوی پوشاک در ایران هستیم.</p>
