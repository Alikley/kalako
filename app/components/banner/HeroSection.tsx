    ...
    <section className="relative w-full bg-kalako-cream overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 flex flex-col pt-4 lg:pr-8">
            <div className="flex items-center gap-2 mb-6">
              <svg
                className="w-5 h-5 text-kalako-orange fill-kalako-orange"
                viewBox="0 0 24 24"
              >
            ...
            <p className="text-kalako-slate-500 text-lg leading-loose font-light max-w-md">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8 pt-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl w-full">
              <FeatureCard
                title="جستجوی هوشمند"
                desc="با هوش مصنوعی جستجو کنید"
                icon={<IconSmartSearch />}
              />
              <FeatureCard
                title="فیلتر دقیق"
                desc="بر اساس نیاز خود جستجو"
                icon={<IconFilter />}
              />
              <FeatureCard
                title="سرعت و پایداری"
                desc="جستجوهای لحظه‌ای و سریع"
                icon={<IconSpeed />}
              />
              <FeatureCard
                title="ارزان‌ترین قیمت"
                desc="کانال‌های فروشگاهی معتبر"
                icon={<IconShield />}
              />
            </div>
          </div>
